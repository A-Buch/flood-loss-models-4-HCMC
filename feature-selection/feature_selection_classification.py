...
Path("../../model_results/models_trained/chance_of_loss/nested_cv_models").mkdir(parents=True, exist_ok=True)
Path("../../model_results/models_trained/chance_of_loss/final_models").mkdir(parents=True, exist_ok=True)
Path("../../model_results/models_evaluation/chance_of_loss").mkdir(parents=True, exist_ok=True)
Path("../../model_results/selected_features/chance_of_loss").mkdir(parents=True, exist_ok=True)
...
for pipe_name in pipelines:
    ...
    print("Drop records with missing values", f"keeping {df_Xy.shape} damage cases for model training and evaluation")
    ...
    predicted_values[model_name].to_excel(
        f"../../model_results/selected_features/chance_of_loss/predictions_{target.replace(' ', '_')}.xlsx", index=True
    )
