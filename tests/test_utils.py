#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""test only functions which failed frequently"""
...
class TestModelEvaluation(unittest.TestCase):
    ...
    def setUp(self):
        Xy = pd.DataFrame({"target": [0, 1, 2, 3, 4, 5, 6], "var1": [0, 21, 22, 32, 42, 52, 62], "var2": [10, 11, 21, 31, 41, 51, 61]})
        self.me_1 = ModelEvaluation(models_trained_ncv=None, Xy=Xy, target_name="target", score_metrics=None, cv=None, kfolds=None, seed=None)
    ...
    def test_negate_scores_from_sklearn_cross_valdiate(self):
        ...
        self.assertEqual(
            self.me_1.negate_scores_from_sklearn_cross_valdiate(
                {
                    "test_MAE": [0.13224787565117258, 0.000000, -0.1255666668136231],
                    "test_R2": [0.01312909501742765, 0.4501174953142224, 0.1746695111706701],
                }
    ...
    def test_calc_p_values(self):
        ...
        """
        coefs_intercept = np.array([7.31132447, -0.0, 0.77320976])
